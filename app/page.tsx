...
function UserSetup({ onComplete, existingUsers }: { onComplete: (u: { id: string; name: string; emoji: string }) => void; existingUsers: AppUser[] }) {
  ...
  return (
    <div className="max-w-sm mx-auto px-4 flex flex-col items-center justify-center min-h-screen">
      ...
      <p className="text-xs mb-1 animate-fade-up" style={{ color: V.muted }}>Your non-negotiables. No excuses.</p>
      <p className="text-[10px] mb-6 animate-fade-up" style={{ color: V.faint, animationDelay: "0.15s" }}>15 minutes a day compounds into everything.</p>
